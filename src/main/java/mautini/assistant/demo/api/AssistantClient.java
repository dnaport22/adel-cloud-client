package mautini.assistant.demo.api;
...
import mautini.assistant.demo.authentication.OAuthCredentials;
import mautini.assistant.demo.config.AssistantConf;
import mautini.assistant.demo.device.Device;
import mautini.assistant.demo.device.DeviceModel;
...
public class AssistantClient implements StreamObserver<AssistResponse> {
    ...
    private AssistRequest getConfigRequest() {
        ...
        assistConfigBuilder = this.getAssistConfigBuilder(
                assistConfigBuilder, audioInConfig, this.textQuery
        );
